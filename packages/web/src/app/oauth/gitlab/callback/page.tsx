...
function GitLabCallbackContent() {
  ...
  if (status === 'loading') {
    return (
      <PageContainer>
        <Loader2 className="w-8 h-8 text-accent-primary animate-spin mx-auto" />
        <p className="mt-2 text-text-secondary">正在授权 GitLab...</p>
      </PageContainer>
    );
  }
  ...
  if (status === 'success') {
    return (
      <PageContainer>
        ...
        <p className="mt-2 text-text-primary font-medium">GitLab 授权成功！</p>
  ...
  return (
    <PageContainer>
      ...
      <p className="mt-2 text-text-primary font-medium">GitLab 授权失败</p>
